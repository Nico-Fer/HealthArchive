...
const PatientHeader: React.FC<PatientHeaderProps> = ({ onSearchChange }) => {
    ...
    return(
        <div className="bg-white shadow-sm mb-1">
            <div className="container d-flex align-items-center py-3">
                ...
                <input type="search" className="form-control form-control-sm" placeholder="Buscador"  onChange={onSearchChange}></input>
